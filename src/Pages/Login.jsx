    ...
    return (
      ...
      <div className="bg-orange-50 shadow-lg rounded-2xl p-8 w-full max-w-md my-8 hover:scale-105 transition ease-in-out duration-1000 animate__animated animate__fadeInDown">
        <h1 className="text-3xl font-bold text-center text-gray-800 mb-6">
          Login to <span className="bg-gradient-to-r from-orange-400 to-orange-300 text-transparent bg-clip-text">WarmPaws</span>
        </h1>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="text-right mb-4">
           <p onClick={() => navigate("/resetpass", { state: { email } })} className="text-blue-600 text-sm hover:underline cursor-pointer">
