    ...
    return (
        <div className=' flex flex-col justify-center items-center my-15'>
            ...
            <Link to={"/"} className='flex justify-center mt-5 mb-10'>
                    <button className="btn w-sm bg-orange-400 hover:bg-gradient-to-r from-orange-700 to-orange-500 text-white font-semibold  hover:scale-105 transition ease-in-out rounded-2xl">
                        Go Back !</button></Link>
        </div>
    );
};
